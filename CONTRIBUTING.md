...
Thanks for your interest in eir!

## Development

eir is a Go module that uses the Docker Engine SDK.
...
# build + end-to-end test (needs a Linux Docker host; ~minutes)
docker build -t eir:ci . && ./tests/e2e/run.sh
```
